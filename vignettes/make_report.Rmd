...
one_drive_loc <- file.path(
  "C:\\Users\\gbarnsle\\Documents\\Covid Vaccine Impact\\global-lmic-reports-orderly\\gh-fits"
)
if(fits_present){
...
run_simulations_id <- orderly::orderly_run("run_simulations",
                                           parameters = list(
                                             ...
                                             parallel = FALSE,
                                             exclude_iso3cs = exclude_iso3cs,
                                             get_from_cluster = TRUE,
                                             cluster_file_loc = "Q:\\Vaccine-Impact-Simulations"
                                             #to save time these have been run with this set of parameters on the DIDE Cluster,
                                             #this option then just pulls in the correct objects from the given file path
                                           ), echo = FALSE)
orderly::orderly_commit(run_simulations_id)
```
