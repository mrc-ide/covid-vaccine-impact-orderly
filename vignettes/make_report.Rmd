...
#run_simulations_id <- "20220113-151542-c092047c"
...
covax_deaths_averted_id <- orderly::orderly_run("covax_deaths_averted",
                                           parameters = list(
                                             date = date,
                                             excess = TRUE,
                                             seed = 100123511
                                           ), echo = FALSE)
orderly::orderly_commit(covax_deaths_averted_id)
```
