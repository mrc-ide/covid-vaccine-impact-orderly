...
orderly::orderly_develop_start("fitting_plots",
                                           parameters = list(
                                             date = date,
                                             excess = TRUE
                                           ))
orderly::orderly_develop_clean("fitting_plots")
```

Generates plots of each fit to go into the appendix, utilises the country fits
not the simulation results

## Delta Adjustment Toy Model

```{r, echo=TRUE, eval=FALSE}
delta_toy_example_id <- orderly::orderly_run("delta_toy_example", echo = FALSE)
orderly::orderly_commit(delta_toy_example_id)

delta_toy_example_india_id <- orderly::orderly_run("delta_toy_example_india", echo = FALSE)
