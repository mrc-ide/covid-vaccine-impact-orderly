...
generated_params <- data.frame(
  ...
  Description = c("How long until vaccine protection (both types) wanes. Roughly calculated 
  ...
  rbind(
    ...
    be susceptible to the Delta variant.",
    ...
    Source = c(
      "-",
      "@prob_hosp_delta",
      "@immune_escape_proper",
      "@vacc_eff_inf_delta",
      "@vacc_eff_inf_delta  REACT Round 14",
      "PHE Vaccine Effectiveness against Hospitalisation preprint",
      "PHE Vaccine Effectiveness against Hospitalisation preprint"
    ),
    category = "d1"
    )
